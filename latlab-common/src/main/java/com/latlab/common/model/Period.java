...
public enum Period implements EnumResolvable {
    ...
    public static List<EnumResolvable> asFutureResolvableList() {
        List<EnumResolvable> resolvables = new ArrayList<>();
        resolvables.addAll(asFutureList());
        return resolvables;
    }

    public static List<EnumResolvable> asPastResolvableList() {
        List<EnumResolvable> resolvables = new ArrayList<>();
